        ...
        <div>
            ...
            >
                <SwiperSlide className='relative'>
                    ...
                    <div className='absolute top-8 lg:top-28 left-6 mr-6 lg:left-32 z-10'>
                        <Reveal keyframes={customAnimation}>
                            <h1 className='text-3xl lg:text-5xl font-bold text-[#f6c459]'>Golden Gate Bridge, <br /> San Francisco, <br /> California</h1>
                        </Reveal>
                        <p className='text-orange-200 w-full md:w-[28rem] lg:w-[36rem] mt-6' style={{ fontWeight: 'bold' }}>
                ...
                <SwiperSlide className='relative'>
                    <img src={niagaraImg} alt="Niagara falls" className='w-full banner-image rounded-3xl' />
                    <div className="absolute w-full h-full top-0 right-0 left-0 -bottom-6 bg-black bg-opacity-30 rounded-3xl"></div>
                    <div className='absolute top-8 lg:top-28 left-6 mr-6 lg:left-32 z-10'>
                        <Reveal keyframes={customAnimation}>
                            <h1 className='text-3xl lg:text-5xl font-bold text-[#f6c459]'>Niagara falls, <br /> New York, <br /> USA</h1>
                        </Reveal>
                        <p className='text-orange-100 w-full md:w-[28rem] lg:w-[36rem] mt-6' style={{ fontWeight: 'bold' }}>
                            {/* Style will be inherited from the parent element */}
                            <Typewriter
                ...
                <SwiperSlide className='relative'>
                    <img src={notredameImg} alt="Notre-Dame Basilica" className='w-full banner-image rounded-3xl' />
                    <div className="absolute w-full h-full top-0 right-0 left-0 -bottom-6 bg-black bg-opacity-30 rounded-3xl"></div>
                    <div className='absolute top-8 lg:top-28 left-6 mr-6 lg:left-32 z-10'>
                        <Reveal keyframes={customAnimation}>
                            <h1 className='text-3xl lg:text-5xl font-bold text-[#f6c459]'>Notre-Dame Basilica, <br /> Montreal, Quebec H2Y 1T1, <br /> Canada</h1>
                        </Reveal>
                        <p className='text-orange-200 w-full md:w-[28rem] lg:w-[36rem] mt-6' style={{ fontWeight: 'bold' }}>
                            {/* Style will be inherited from the parent element */}
                            <Typewriter
                ...
                <SwiperSlide className='relative'>
                    <img src={ibirapueraImg} alt="Ibirapuera Park, São Paulo" className='w-full banner-image rounded-3xl' />
                    <div className="absolute w-full h-full top-0 right-0 left-0 -bottom-6 bg-black bg-opacity-30 rounded-3xl"></div>
                    <div className='absolute top-8 lg:top-28 left-6 mr-6 lg:left-32 z-10'>
                        <Reveal keyframes={customAnimation}>
                            <h1 className='text-3xl lg:text-5xl font-bold text-[#f6c459]'>Ibirapuera Park, <br /> São Paulo, <br /> Brazil</h1>
                        </Reveal>
                        <p className='text-orange-200 w-full md:w-[28rem] lg:w-[36rem] mt-6' style={{ fontWeight: 'bold' }}>
                            {/* Style will be inherited from the parent element */}
                            <Typewriter
                ...
                <SwiperSlide className='relative'>
                    <img src={mexicoCityImg} alt="Mexico City, Mexico" className='w-full banner-image rounded-3xl' />
                    <div className="absolute w-full h-full top-0 right-0 left-0 -bottom-6 bg-black bg-opacity-30 rounded-3xl"></div>
                    <div className='absolute top-8 lg:top-28 left-6 mr-6 lg:left-32 z-10'>
                        <Reveal keyframes={customAnimation}>
                            <h1 className='text-3xl lg:text-5xl font-bold text-[#f6c459]'>Mexico City, <br /> Mexico</h1>
                        </Reveal>
                        <p className='text-orange-200 w-full md:w-[28rem] lg:w-[36rem] mt-6' style={{ fontWeight: 'bold' }}>
                            {/* Style will be inherited from the parent element */}
                            <Typewriter
